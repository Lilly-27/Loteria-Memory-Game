...
// Creating an array of objects with all my cards:
    ...
    const cardsArray = [
        {name: 'El-Nopal', img: "lib/cards/el_nopal.png"},{name: 'El-Nopal', img: "lib/cards/el_nopal.png"},
    
        {name: 'El-Pescado', img: "lib/cards/el_pescado.png"},{name: 'El-Pescado', img: "lib/cards/el_pescado.png"},
    
        {name: 'La-Calavera', img: "lib/cards/la_calavera.png"},{name: 'La-Calavera', img: "lib/cards/la_calavera.png"},
    
        {name: 'La-Luna', img: "lib/cards/la_luna.png"},{name: 'La-Luna', img: "lib/cards/la_luna.png"},
    
        {name: 'La-Rosa', img: "lib/cards/la_rosa.png"},{name: 'La-Rosa', img: "lib/cards/la_rosa.png"},
    
        {name: 'La-Sandia', img: "lib/cards/la_sandia.png"},{name: 'La-Sandia', img: "lib/cards/la_sandia.png"},
    ]
...
function createBoard () {
    for (let i=0; i < cardsArray.length; i++) {
        ...
        card.setAttribute('src', 'lib/cards/back_card.png');
...
function checkMatch () {
    ...
    if (cardsChosen[0].getAttribute('src') === cardsChosen[1].getAttribute('src')) {
        ...
        cards[firstOptionId].setAttribute('src', 'lib/cards/blank_space.png')
        cards[secondOptionId].setAttribute('src', 'lib/cards/blank_space.png')
        match.push(cardsChosen[0])
        match.push(cardsChosen[1])
        result.innerText = parseInt(result.innerText) + 20
        win()
    } else {
        cards[firstOptionId].setAttribute('src', 'lib/cards/back_card.png')
        cards[secondOptionId].setAttribute('src', 'lib/cards/back_card.png')
